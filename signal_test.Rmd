...
library(GenomicRanges)
source('~/NystLib/Scripts/NystLib/R/peakUtils.R')
```


```{r test_data}
load('~/CtBP_CnR/ctbp_cnr_analysis/analysis/R_out/ctbp_Sheet.rda')

#correct the path
ctbp_Sheet <- data.frame(ctbp_Sheet %>%
  lapply(function(x) {
    gsub("m/McKay", "mniederhuber", x)
  }))

ctbp_Sheet

bw_path <- '/Users/mniederhuber/FAIRE_dm6/BigWig/wt_3LW_dm6_trim_q5_sorted_dupsRemoved_POOLED_rpgcNorm_zNorm.bw'

bw_list <- c('/Users/mniederhuber/FAIRE_dm6/BigWig/wt_3LW_dm6_trim_q5_sorted_dupsRemoved_POOLED_rpgcNorm_zNorm.bw',
             '/Users/mniederhuber/FAIRE_dm6/BigWig/wt_24h_dm6_trim_q5_sorted_dupsRemoved_POOLED_rpgcNorm_zNorm.bw',
             '/Users/mniederhuber/FAIRE_dm6/BigWig/wt_44h_dm6_trim_q5_sorted_dupsRemoved_POOLED_rpgcNorm_zNorm.bw')
